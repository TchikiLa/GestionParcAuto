					...
					<div class="container">
						...
						<div class="row">
							<div class="col-md-12">
								<ol class="breadcrumb">
									...
									<li class="active">
										Ajouter véhicule / assurence / contrôle technique 
									</li>
								</ol>
							</div>
						</div>
							...
							<div class="col-md-12">
								...
								<div class="panel panel-white">
									<div class="panel-heading">
										<h4 class="panel-title"><span class="text-bold">Information General </span></h4>
									</div>
									<div class="panel-body">
								        <form action="inserer_vehicule.php" role="form" id="form" method="post">
											<div class="row">
												<div class="col-md-6">
													<div class="form-group">
														<label class="control-label">
															Immatriculation <span class="symbol required"></span>
														</label>
														<input type="text" placeholder="Iserer l'immatriculation du véhicule " class="form-control" id="immatriculation" name="immatriculation">
													</div>
													<div class="form-group">
														<label class="control-label">
															Marque <span class="symbol required"></span>
														</label>
														<input type="text" placeholder="Iserer la marque du véhicule " class="form-control" id="marque" name="marque">
													</div>
													<div class="form-group">
														<label class="control-label">
															Modèle <span class="symbol required"></span>
														</label>
														<input type="text" placeholder="Iserer le modele du véhicule" class="form-control" id="modele" name="modele">
													</div>
													<div class="form-group">
														<label class="control-label">
															Nombre de place <span class="symbol required"></span>
														</label>
														<input type="text" placeholder="inserer le nembre de place du véhicule" class="form-control" id="nbrplace" name="nbrplace">
													</div>
													<div class="form-group">
														<label class="control-label">
															puissance <span class="symbol required"></span>
														</label>
														<input type="text" placeholder="Iserer le nembre de cheveaux du véhicule " class="form-control" id="puissance" name="puissance">
													</div>
													<div class="form-group">
														<label class="control-label">
															N°chassis <span class="symbol required"></span>
														</label>
														<input type="text" placeholder="Iserer le N°chassis du véhicule" class="form-control" id="numchassis" name="numchassis">
													</div>
												</div>
												<div class="col-md-6">
												    <div class="form-group">
														<label class="control-label">
															Catégorie <span class="symbol required"></span>
														</label>
														<input type="text" placeholder="Iserer la catégorie du véhicule" class="form-control" id="categorie" name="categorie">
													</div>
													<div class="form-group connected-group">
														<label class="control-label">
															Date de circulation <span class="symbol required"></span>
														</label>
														<div class="row">
															<div class="col-md-3">
													...
													<div class="form-group">
														<label class="control-label">
															Couleur <span class="symbol required"></span>
														</label>
														<input type="text" placeholder="Inserer la couleur du véhicule" class="form-control" id="couleur" name="couleur">
													</div>
													<div class="form-group">
														<label class="control-label">
															Kilométrage <span class="symbol required"></span>
														</label>
													<div class="row">
														<div class="col-md-3">
																<input type="text" placeholder="Km" id="kilometrage" name="kilometrage" class="form-control">
														</div>
													</div>
													</div>
											    </div>
						...
						<div class="row">
							<div class="col-md-12">
								...
								<div class="panel panel-white">
									<div class="panel-heading">
										<h4 class="panel-title"><span class="text-bold">Ajouter assurence </span></h4>
									</div>
									<div class="panel-body">
								        <form action="ajouter_assurence.php" role="form" id="form" method="post">
											<div class="row">
												<div class="col-md-6">
													<div class="form-group connected-group">
														<label class="control-label">
						...
						<div class="row">
							<div class="col-md-12">
								...
								<div class="panel panel-white">
									<div class="panel-heading">
										<h4 class="panel-title"><span class="text-bold">Ajouter contrôle technique </span></h4>
									</div>
									<div class="panel-body">
								        <form action="ajouter_ctrltec.php" role="form" id="form" method="post">
											<div class="row">
												<div class="col-md-6">
													<div class="form-group connected-group">
														<label class="control-label">
