							...
							<div class="col-md-12">
								...
								<div class="panel panel-white">
									<div class="panel-heading">
										...
										<h4 class="panel-title"><span class="text-bold">Liste des Véhicules </span></h4>
										...
										<table class="table table-hover" id="sample-table-1">
											<thead>
												<tr>
													...
													<th class="center">Modèle</th>
													<th class="center">N°chassis</th>
													<th class="center">Date de circulation</th>
													<th class="center">Kilométrage</th>
													<th class="center">Date expiration Assurance</th>
													<th class="center">Date expiration Contrôle Technique</th>
													<th></th>
												</tr>
											</thead>
											<?php
													...
													if(count($errors) == 0){
													$req="SELECT vehicule.id_vehicule,immat,marque,modele,numchass,datecirculation,kilometrage,assurance.date_fin as 'a',controletec.date_fin as 'b' FROM vehicule,controletec,assurance WHERE vehicule.id_vehicule=assurance.id_vehicule AND vehicule.id_vehicule=controletec.id_vehicule AND controletec.id_vehicule=assurance.id_vehicule GROUP BY vehicule.id_vehicule ";
													$res=mysqli_query($conn,$req);
													$tab="<tbody>";
													if($res && $number=mysqli_num_rows($res)>0){
														while($tabres=mysqli_fetch_assoc($res)){
														$_matt=$tabres['immat'];
														$_marque=$tabres['marque'];
														$_modele=$tabres['modele'];
														$_numchass=$tabres['numchass'];
														$_datecirculation=$tabres['datecirculation'];
														$_kilometrage=$tabres['kilometrage'];
														$_finass=$tabres['a'];
														$_finctr=$tabres['b'];
		
														
														$tab.="<tr>
													<td class='center'>".$_matt."</td>
													<td class='center'>".$_marque."</td>
													<td class='center'>".$_modele."</td>
													<td class='center'>".$_numchass."</td>
													<td class='center'>".$_datecirculation."</td>
													<td class='center'>".$_kilometrage."</td>
													<td class='center'>".$_finass."</td>
													<td class='center'>".$_finctr."</td>
													<td class='center'>
													<div class='visible-md visible-lg hidden-sm hidden-xs'>
														<a href='modier_vehicule.php' class='btn btn-xs btn-blue tooltips' data-placement='top' data-original-title='Modifier'><i class='fa fa-edit'></i></a>
